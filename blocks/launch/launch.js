...
const CHECKLIST = [
  ...
  'Product hero image generated by Adobe Firefly',
  'Product page created in DA.live via EDS Admin API',
  'Blog article auto-drafted from product description',
  'Campaign page with scheduled publish and auto-expiry',
  'PDF brochure generated with Firefly visuals',
  'All tasks assigned with SEO and accessibility metrics',
];
  ...
  block.innerHTML = `
    ...
    <div class="launch-grid">
      <div class="launch-info sr sr-d1">
        <h3>Submit your product details. ContentFlow handles everything else.</h3>
