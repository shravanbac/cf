...
const SOLUTION_STEPS = [
  {
    num: '01',
    title: 'Submit',
    desc: 'Fill one form with product details — name, tagline, features. The only manual step.',
    color: '#4B9CF5',
  ...
  },
  {
    num: '02',
    title: 'Auto-Create',
    desc: 'Fusion creates a Workfront project, product page, article, campaign, and brochure.',
    color: '#B07CE8',
  ...
  },
  {
    num: '03',
    title: 'Refine & Review',
    desc: 'Authors polish in DA.live. One click sends for review with SEO and accessibility scores.',
    color: '#F5A623',
  ...
  },
  {
    ...
    desc: 'Approved content publishes automatically. Campaigns auto-unpublish on schedule.',
    color: '#33AB84',
